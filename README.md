...
Reading assets (models, textures, shaders, scripts)

Processing and transforming this data

Rendering the final result to the screen

Handling interaction through input, events, and systems
...
BerryFlux is inspired by modern open source engines and educational resources on game engine architecture.
