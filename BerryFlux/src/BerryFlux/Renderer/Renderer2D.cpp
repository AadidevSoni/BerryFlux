...
namespace BerryFlux {
  ...
  {
    std::dynamic_pointer_cast<OpenGLShader>(s_Data->FlatColorShader)->Bind(); //Bind the shader before setting the uniform
  ...
  {
    std::dynamic_pointer_cast<OpenGLShader>(s_Data->FlatColorShader)->Bind(); //Making sure shader is bound
