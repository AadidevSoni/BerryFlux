...
namespace BerryFlux { //This is just an interface anddoesnt store any data
  ...
  static uint32_t ShaderDataTypeSize(ShaderDataType typ) 
  {
    switch(typ)
    {
  ...
  class BufferLayout {
    public:
      ...
      //For iteration through every element in the layout
    ...
    private:
      ...
      uint32_t m_Stride = 0; //This is the space between different elements. 3 * sizeof(float) there
  };  
